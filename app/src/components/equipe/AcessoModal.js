  ...
  const handleColaboradorSelect = (e) => {
    ...
    if (colab) {
      ...
      setFormData({
        ...
        data: colab.data || new Date().toISOString().split("T")[0],
        ativo: colab.ativo,
      });
    }
  };
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header ">
            ...
            <div>
              {!acesso && 
                <button className="btn btn-primary" onClick={() => setModalColaboradorAberto(true)}>
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
              ...
              <input type="text" className="form-control" name="nome" readOnly value={formData.nome} onChange={handleChange} />
            </div>

            <div className="mb-3">
              <label className="form-label">Email</label>
              <input type="email" className="form-control" name="email" readOnly value={formData.email} onChange={handleChange} />
            </div>
